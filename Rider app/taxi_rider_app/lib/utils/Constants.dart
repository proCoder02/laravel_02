...
const GOOGLE_MAP_API_KEY = 'ADD YOUR GOOGLE MAP API KEY';
//endregion

//region DomainUrl
const DOMAIN_URL = 'ADD YOUR DOMAIN URL'; // Don't add slash at the end of the url
//endregion

//region MQTT port and unique name
final client = MqttServerClient.withPort("broker.hivemq.com", "", 1883);
const MQTT_UNIQUE_TOPIC_NAME = 'ADD YOUR MQTT UNIQUE TOPIC NAME'; // Don't add underscore at the end of the url
//endregion
